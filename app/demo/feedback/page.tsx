    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-cyan-400 to-white flex items-center justify-center">
        <div className="text-center bg-white rounded-2xl shadow-xl p-8 max-w-md">
          <h1 className="text-2xl font-bold text-gray-800 mb-4">No Feedback Found</h1>
          <p className="text-gray-600 mb-6">We couldn't find your demo feedback. Please try the demonstration again.</p>
          <Link
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-400 to-white">
      ...
      <main className="container mx-auto px-6 py-12 max-w-4xl">
        ...
        <div className="bg-gradient-to-r from-cyan-500 to-cyan-600 rounded-3xl shadow-xl p-8 mb-8 text-white">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex-1">
              <h2 className="text-3xl font-extralight mb-3 font-concretica">
                Save Your Progress!
              </h2>
              ...
              <div className="flex flex-wrap gap-4 mt-4">
                <Link
                  href="/auth/sign-up"
                  className="px-8 py-3 bg-white text-cyan-600 rounded-full font-medium hover:shadow-lg transform hover:scale-105 transition-all duration-300"
                >
                  Sign Up Free
                </Link>
                <Link
                  href="/auth/sign-in"
                  className="px-8 py-3 bg-white/20 text-white border-2 border-white rounded-full font-medium hover:bg-white/30 transition-all duration-300"
                >
                  Sign In
                </Link>
              </div>
        ...
        {/* Feedback Content */}
        <div className="bg-white/95 rounded-3xl shadow-xl p-8 mb-8">
          <div className="mb-6">
            <h1 className="text-4xl font-extralight text-gray-800 mb-2 font-concretica">
          ...
          {/* Score Section */}
          <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 rounded-2xl p-6 mb-8">
            <div className="flex items-center justify-between mb-4">
              <div>
                <p className="text-sm font-medium text-gray-600 mb-1">Overall Score</p>
                <p className="text-5xl font-bold text-cyan-600">{feedback.overallScore}</p>
              </div>
              <div className="text-right">
                <p className="text-2xl font-light text-gray-600">/100</p>
                <div className="w-48 h-3 bg-white rounded-full mt-4">
                  <div
          ...
          {feedback.strengths && feedback.strengths.length > 0 && (
            <div className="mb-8">
              <h3 className="text-2xl font-extralight text-gray-800 mb-4 font-concretica flex items-center gap-3">
            ...
            <div className="mb-8">
              ...
              <ul className="space-y-3">
                {feedback.weaknesses.map((weakness, idx) => (
                  <li key={idx} className="flex items-start gap-3 p-4 bg-amber-50 rounded-xl border border-amber-200">
            ...
            <div className="mb-8">
              ...
              <ul className="space-y-3">
                {feedback.recommendations.map((recommendation, idx) => (
                  <li key={idx} className="flex items-start gap-3 p-4 bg-blue-50 rounded-xl border border-blue-200">
          ...
          {feedback.detailedAnalysis && (
            <div className="mb-8">
              <h3 className="text-2xl font-extralight text-gray-800 mb-4 font-concretica">
                Detailed Analysis
              </h3>
        ...
        <div className="bg-white/95 rounded-3xl shadow-xl p-8 text-center">
          <h2 className="text-3xl font-extralight text-gray-800 mb-4 font-concretica">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/auth/sign-up"
              className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-cyan-600 text-white rounded-full font-medium hover:shadow-lg transform hover:scale-105 transition-all duration-300"
            >
              Sign Up Free
            </Link>
            <Link
              href="/"
              className="px-8 py-4 bg-gray-100 text-gray-700 rounded-full font-medium hover:bg-gray-200 transition-all duration-300"
            >
              Back to Home
            </Link>
          </div>
