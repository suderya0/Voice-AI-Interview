    ...
    <div className="min-h-screen bg-gradient-to-br from-cyan-400 to-white dark:from-slate-900 dark:to-slate-950">
      ...
      <main className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 lg:py-16">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[60vh] lg:min-h-[70vh]">
          ...
          <div className="flex flex-col items-start space-y-6 sm:space-y-8 text-center lg:text-left">
            ...
            <Link href="/interview/create?demo=true" className="w-full lg:w-auto">
              <button className="w-full sm:w-auto px-8 sm:px-10 py-3 sm:py-4 rounded-full text-base sm:text-lg font-medium shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 bg-white text-cyan-600 dark:bg-cyan-500 dark:text-white dark:hover:bg-cyan-400">
                Try Demo For Free
              </button>
            </Link>
          </div>
          ...
          <div className="relative flex flex-col items-center lg:items-end space-y-4 sm:space-y-6 mt-8 lg:mt-0">
            ...
            {bubble1Visible && (
              <div className={`relative w-full sm:w-80 max-w-sm lg:max-w-none bg-white/95 dark:bg-slate-900/90 rounded-2xl sm:rounded-3xl rounded-tr-sm p-4 sm:p-5 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 animate-fadeIn`}>
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-gray-700 dark:text-slate-100 text-xs sm:text-sm leading-relaxed break-words">
                      {bubble1Text}
            ...
            {bubble2Visible && (
              <div className={`relative w-full sm:w-80 max-w-sm lg:max-w-none bg-white/95 dark:bg-slate-900/90 rounded-2xl sm:rounded-3xl rounded-tr-sm p-4 sm:p-5 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 lg:ml-12 animate-fadeIn`}>
                <div className="flex items-start gap-3 sm:gap-4">
                  <div className="flex-1 min-w-0">
                    <p className="text-gray-700 dark:text-slate-100 text-xs sm:text-sm leading-relaxed break-words">
                      {bubble2Text}
        ...
        <div className="mt-12 sm:mt-16 lg:mt-24 mb-12 sm:mb-16">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extralight text-white mb-4 sm:mb-6 text-center font-concretica px-4">
            What is icareerly?
          </h2>
          
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto px-4">
            <div className="bg-white/95 dark:bg-slate-900/90 rounded-2xl sm:rounded-3xl shadow-xl p-6 sm:p-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="flex flex-col items-center text-center mb-4 sm:mb-6">
                ...
                <h3 className="text-xl sm:text-2xl font-extralight text-gray-800 dark:text-slate-100 font-concretica mb-2 sm:mb-3">AI-Powered Practice</h3>
              </div>
              <p className="text-gray-600 dark:text-slate-300 text-sm sm:text-base leading-relaxed text-center">
            ...
            <div className="bg-white/95 dark:bg-slate-900/90 rounded-2xl sm:rounded-3xl shadow-xl p-6 sm:p-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="flex flex-col items-center text-center mb-4 sm:mb-6">
                ...
                <h3 className="text-xl sm:text-2xl font-extralight text-gray-800 dark:text-slate-100 font-concretica mb-2 sm:mb-3">Customizable Difficulty</h3>
              </div>
              <p className="text-gray-600 dark:text-slate-300 text-sm sm:text-base leading-relaxed text-center">
            ...
            <div className="bg-white/95 dark:bg-slate-900/90 rounded-2xl sm:rounded-3xl shadow-xl p-6 sm:p-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 sm:col-span-2 lg:col-span-1">
              <div className="flex flex-col items-center text-center mb-4 sm:mb-6">
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-cyan-400 to-cyan-600 rounded-xl sm:rounded-2xl flex items-center justify-center mb-3 sm:mb-4">
                  <svg className="w-6 h-6 sm:w-8 sm:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 className="text-xl sm:text-2xl font-extralight text-gray-800 dark:text-slate-100 font-concretica mb-2 sm:mb-3">Stress-Free Learning</h3>
              </div>
              <p className="text-gray-600 dark:text-slate-300 text-sm sm:text-base leading-relaxed text-center">
        ...
        <div className="mb-6 sm:mb-8 flex justify-center">
            <Link
              href="/faq"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-sm sm:text-base font-medium shadow-md hover:shadow-lg transition-colors bg-white/90 text-cyan-600 hover:bg-white dark:bg-slate-800 dark:text-slate-100 dark:hover:bg-slate-700"
            >
              <span>Any questions? Visit our FAQ</span>
              <svg
                className="w-4 h-4"
                fill="none"
                stroke="currentColor"
